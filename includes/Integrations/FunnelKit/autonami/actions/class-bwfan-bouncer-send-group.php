...
class BWFAN_Bouncer_Send_Group extends BWFAN_Action {

	private static $instance = null;
	private $progress = false;

	public function __construct() {
		$this->action_name = __( 'Send to Group', 'autonami-automations-connectors' );
		$this->action_desc = __( 'This action sends message to a WhatsApp Group via Bouncer', 'autonami-automations-connectors' );
		$this->support_v2  = true;
	}

	/**
	 * @return BWFAN_Bouncer_Send_Group|null
	 */
	...
	public function load_hooks() {
		add_filter( 'bwfan_modify_send_message_body', [ $this, 'shorten_link' ], 15, 2 );
	}
	...
	public function get_view() {
        ...
        <script type="text/html" id="tmpl-action-<?php echo esc_attr__( $unique_slug ); ?>">
            ...
            <div data-element-type="bwfan-editor" class="bwfan-<?php echo esc_attr__( $unique_slug ); ?>">
                <label for="" class="bwfan-label-title">
					<?php
					echo esc_html__( 'Group ID', 'autonami-automations-connectors' );
                ...
                <div class="bwfan-col-sm-12 bwfan-pl-0 bwfan-pr-0 bwfan-mb-15">
                    <input required type="text" class="bwfan-input-wrapper bwfan-field-<?php echo esc_attr__( $unique_slug ); ?>" name="bwfan[{{data.action_id}}][data][sms_to]" placeholder="E.g. 60125153307-1623300099@g.us" value="{{sms_to}}"/>
                </div>
                ...
                <div class="bwfan-col-sm-12 bwfan-pl-0 bwfan-pr-0 bwfan-mb-15">
					...
					<input type="text" name="test_message" placeholder="xxxxxxxx@g.us" id="bwfan_test_message_group">
                        <input type="button" class="button bwfan-btn-inner" id="bwfan_test_message_group_btn" value="<?php esc_html_e( 'Send', 'autonami-automations-connectors' ); ?>">
                    </div>
                    <div class="clearfix bwfan_field_desc">
					<?php esc_html_e( 'Enter WhatsApp group ID', 'wp-marketing-automations' ); ?>
                    </div>
                </div>
        ...
        <script>
            ...
            jQuery(document).on('click', '#bwfan_test_message_group_btn', function () {
                var smsInputElem = jQuery('#bwfan_test_message_group');
                var el = jQuery(this);
                ...
                ajax.ajax('test_message_group', data_to_send);
	...
	protected function create_engagement( $phone, $automation_id, $body ) {
		...
		$conversation->add_merge_tags_from_string( $body, array(), false );
	...
	public function get_fields_schema() {
		...
		return [
			[
				'id'          => 'sms_to',
				'label'       => __( "Group ID", 'wp-marketing-automations' ),
				'type'        => 'text',
				'placeholder' => "E.g. 60125153307-1623300099@g.us",
			...
			[
				...
				'send_action' => 'bwf_test_message_group',
				'send_field'  => [
					'sms_to'            => 'test_sms',
...
return 'BWFAN_Bouncer_Send_Group';
